    ...
    (
      ...
      const ON_CANCEL = () => {
        ...
        if (
          ...
          console.log(inputRefs.current?.find((element) => {
            return element.value?.length > 0;
          }))

          console.log(formData?.find((element) => {
            return element?.data !== "";
          }))
      ...
      const cancelOperation = () => {
        ...
        if (onCancel) {
          selectedValueFxnRefs.current.forEach(obj=>{
            return obj.setSelectedValue("");
          })
        ...
        <>
          ...
          <main className="w-fit  mx-auto">
            ...
            <section className="flex w-full">
              <form className="min-w-[200px]" style={Styles?.form}>
                {formData?.length > 0 &&
                      ...
                      element?.input?.type !== "file" && (
                          ...
                          >
                            <div
                              ...
                              style={{...Styles?.label, marginRight:'10px'}}
                            >
                              {element?.label}{" "}
